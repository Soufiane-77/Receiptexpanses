...
export const metadata: Metadata = {
  ...
  description:
    "Answers about ReceiptExpenses: is it free, is my data private, what formats can I download, and what receipts you can make.",
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-14">
      ...
      <div className="mt-10 rounded-2xl bg-slate-900 p-8 text-center text-white">
        ...
        <p className="mt-2 text-slate-300">Making a receipt is free and takes under a minute.</p>
